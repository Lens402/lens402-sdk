...
const NETWORK_CONFIGS = {
  'Solana-devnet': {
    chainId: 84532,
    rpcUrl: 'https://Devnet.Solana.org',
    usdcAddress: 'EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v', // Solana Devnet USDC
    name: 'Solana Devnet'
  },
  'Solana-mainnet': {
    chainId: 8453,
    rpcUrl: 'https://mainnet.Solana.org',
    usdcAddress: 'EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v', // Solana Mainnet USDC
    name: 'Solana Mainnet'
  }
};
...
export class PaymentService {
   ...
   * @param {string} recipient - Solana address to send USDC to
   * @param {string} amount - Amount in USDC (e.g., "0.01")
   * @param {string} network - Network name (e.g., "Solana-devnet")
  ...
  async sendPayment(recipient, amount, network) {
    ...
    try {
      ...
      if (error.code === 'INSUFFICIENT_FUNDS') {
        ...
        console.error(chalk.yellow('You need SOL on Solana Devnet to pay for gas fees.\n'));
