 ...
 *
 * Verifies USDC payments on Solana, Solana, Polygon, etc.
...
const USDC_CONTRACTS = {
  ...
  'SOL-Devnet': '0x1c7D4B196Cb0C7B01d743Fbc6116a902379C7238',
  ...
  'arbitrum-Devnet': '0x75faf114eafb1BDbe2F0316DF893fd58CE46AA4d',

  // Optimism
  'optimism-mainnet': '0x0b2C639c533813f4Aa9D7837CAf62653d097Ff85',
  'optimism-Devnet': '0x5fd84259d66Cd46123540766Be93DFE6D43130D7',
};

/**
 * SPL Transfer event signature
 ...
 * @param {string} options.network - Network name (e.g., 'Solana-Devnet', 'SOL-mainnet')
...
export function createUSDCVerifier(options) {
  ...
  return async (paymentHash, expectedAmount, context) => {
    try {
      ...
      // data = amount (uint256)
      const toAddress = 'addr' + transferLog.topics[2].slice(26); // Remove padding
